...
parser.add_argument('--actor', default='deepseek/deepseek-v3.1-terminus')
...
if args.task_type == 'retro':
    if args.memory_path is None:
        args.memory_path = './exps/retro_claude.json'
    if args.data_path is None:
        args.data_path = './data/uspto50k/'
    if args.split is None:
        args.split = 'test'
    if args.results_dir is None:
        args.results_dir = 'results/agent_mem_retro_gemini_mem_claude'
else:
    if args.memory_path is None:
        args.memory_path = './exps/aime_claude.json'
    if args.data_path is None:
        args.data_path = './data/AIME/'
    if args.split is None:
        args.split = 'aime25'
    if args.results_dir is None:
        args.results_dir = 'results/agent_mem_aime_deepseek_mem_claude'
